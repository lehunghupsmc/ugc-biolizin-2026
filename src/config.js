...
module.exports = {
  ...
  // Google Sheet IDs
  GOOGLE_SOURCE_SHEET_ID: process.env.GOOGLE_SOURCE_SHEET_ID || '18wS4ljZvhVnq_Ek-eLHyGkjKCPJPc4kqgy4aKKRukNw',
  ...
  SOURCE_RANGE: process.env.GOOGLE_SOURCE_RANGE || 'M:P',
